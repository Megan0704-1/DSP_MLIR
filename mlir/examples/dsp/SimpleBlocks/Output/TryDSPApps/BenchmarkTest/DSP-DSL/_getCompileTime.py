...
"radarSignalProcessing.py", "signalSmoothing.py", "speakerIdentification.py", "targetDetection.py", "vibrationAnalysis.py", "audioEqualization.py", \
"digitalModulation.py", "echoCancellation.py", "hearingAid.py", "lowPassFiltering.py", "periodogram2Conv1.py", "spaceCommunication.py", "spectralAnalysis.py", \
"underWaterCommunication.py", "voiceActivityDetection.py", "FIRFilterDesign.py", "convolutionthm.py", "noiseCancellation.py", "periodogram.py"]
data = []
